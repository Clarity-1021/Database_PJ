<template>
  <v-container style="min-width: 900px" fluid>
    <v-container fluid>
      <v-card dark color="blue darken-3" class="py-3">所有的病房护士</v-card>
    ...
    <SearchPatientNurseWard :currentItem="currentItem" v-if="funcType==='查询病人'" />
    <AddDailyPatientInfo :currentItem="currentItem" v-if="funcType==='登记病人每日信息'" />
  </v-container>
</template>
